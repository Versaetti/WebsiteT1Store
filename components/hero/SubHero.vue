  ...
  <div class="grid lg:grid-cols-3 grid-cols-1 g gap-8 px-4 mt-28 mb-16">
    <div class="grid grid-flow-row gap-6">
      <div class="relative overflow-hidden img-zoom-hover">
        <img src="https://tietkiemdiennang.net/wp-content/uploads/2020/08/thiet-bi-dien-tu-la-gi-1-2.jpg" alt="hero photo">
      ...
      <div class="relative overflow-hidden img-zoom-hover">
        <img src="https://png.pngtree.com/background/20230519/original/pngtree-store-filled-with-clothing-picture-image_2661546.jpg" alt="hero photo">
        <div class="product_var_one_text">
          <h4 class="color_one text-2xl font-semibold">
            SUMMER
          </h4>
    ...
    <div>
      <div class="relative overflow-hidden img-zoom-hover">
        <img src="https://mlti.com.mx/wp-content/uploads/2023/11/vista-superior-equipo-juego-scaled.jpg" alt="hero photo">
    ...
    <div class=" grid-flow-row gap-6 lg:grid hidden ">
      <div class="relative overflow-hidden img-zoom-hover">
        <img src="https://down-vn.img.susercontent.com/file/sg-11134202-7rcdq-lsjcxskgiggdb3" alt="hero photo">
        <div class="product_var_one_text">
          <h2 class="text text-3xl text-black font-bold">
            NEW
          </h2>
      ...
      <div class="relative overflow-hidden img-zoom-hover">
        <img src="https://images2.alphacoders.com/134/thumb-1920-1340820.png" alt="hero photo">
        <div class="product_var_one_text">
          <h2 class="text text-3xl text-black font-bold">
            HOT
          </h2>
