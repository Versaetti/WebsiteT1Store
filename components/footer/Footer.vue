  ...
  <div class="flex flex-col bg-[#f6f6f6]">
    <div class="mt-6 px-10 flex flex-col items-center justify-center">
      ...
      <p class="font-medium mb-6">
        Follow để biết thêm thông tin về chúng tôi
      </p>
    </div>
    ...
    <footer class="bg-[#f6f6f6] p-10 lg:p-0">
      <div class="py-16 mx-auto sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div>
            <img src="https://ext.fmkorea.com/files/attach/new3/20231119/14339012/3707668246/6413487828/bc8d811b64d7980c0897ed50c1ed0076.png?c=20231119225129" class="mr-5 h-10 sm:h-[70px]" alt="logo">
            <p class="max-w-xs mt-3 text-[1rem] text-black">
              T1 Store has been launched in Vietnam with the orientation of an e-commerce website.
            </p>
...
export default {
  ...
  data () {
    return {
      imgs: [
        require('@/static/instagram/instagram1.jpg'),
        require('@/static/instagram/instagram2.jpg'),
        require('@/static/instagram/instagram3.jpg'),
        require('@/static/instagram/instagram4.jpg'),
